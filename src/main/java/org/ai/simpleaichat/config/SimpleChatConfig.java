package org.ai.simpleaichat.config;

import ch.qos.logback.classic.LoggerContext;
import org.ai.simpleaichat.service.SimpleChatService;
...
public class SimpleChatConfig {
    ...
    @Bean
    public CommandLineRunner cli(@Value("${spring.application.name}") String applicationName, SimpleChatService simpleChatService) {
        return args -> {
